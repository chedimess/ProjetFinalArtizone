...
import {getrate} from "../../js/action/rateAction"
    ...
    return (
      ...
      <div className="card p-3">
          <div className="d-flex align-items-center">
              <div > <img src="https://previews.123rf.com/images/jemastock/jemastock1709/jemastock170909982/85612118-travailleur-de-r%C3%A9paration-ou-avatar-bricoleur-avec-bras-crois%C3%A9s-ic%C3%B4ne-image-vector-illustration-design.jpg" className="rounded image2" alt="img1" /> </div>
